...
//        mAdView.loadAd(adRequest);
        ...
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #3 - nCoV Myths Vs Science", "https://youtu.be/Iy1xeIVeRwY"));
        ...
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #6 - Flu & nCoV", "https://youtu.be/0taCcDHTURw"));
        ...
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #9 - Air pollution & nCoV", "https://youtu.be/Lbk1i67KQLY"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #10 - Ventilation & nCoV", "https://youtu.be/XJC1f7F4qtc"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #11 - Antibiotics & nCoV", "https://youtu.be/lFpLIDQcdyQ"));
        ...
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #13 - nCoV - Vaccine trials", "https://youtu.be/DejroJH8-uA"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #14 - nCoV - Tests", "https://youtu.be/Odltcv6q96I"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #15 - nCoV - Vaccine distribution", "https://youtu.be/FFwvwIZQWa4"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #16 - nCoV - Vaccine technologies", "https://youtu.be/V4JAo9PhnoI"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #17 - nCoV - Vaccine approvals", "https://youtu.be/ofnMToabi50"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #18 - nCoV - Immunity after recovery from nCoV", "https://youtu.be/OIsz3-Mz3eQ"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #19 - nCoV - Prolonged symptoms after nCoV ", "https://youtu.be/KNUnoIbchJI"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #20 - nCoV - Variants & Vaccines", "https://youtu.be/gjnPZKMNmqc"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #21 - nCoV - Origins of the SARS-CoV-2 virus", "https://youtu.be/SO1N3-s05QA"));
        advisoryContent.add(new com.daily_cases_reports.android.AdvisoryAdapterClass.Advisory("Episode #22 - Children & nCoV", "https://youtu.be/t6OYU8WH9Ww"));
