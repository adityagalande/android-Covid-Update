...
public class AboutUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        content = "\n\nThe content of this App is for information purposes. It gives real-time cases update worldwide, India, The United States. Our motto is to make awareness in our society about pandamic. \n" +
                "\n" +
                "\n" +
                ...
                "\n" +
                "\n" +
                "We are issue this App and it's content fighting against the pandemic. All advisory information publish through this App is guidelines only. App users are advised to follow local rules and regulations, Health safety requirement of respective authority on any  issue dealing with virus and their response.\n" +
                "\n" +
                "\n" +
